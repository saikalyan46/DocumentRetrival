...
Query = ["ministry of zambia", "Lowpel and Geowaltek Nigeria Limited founder", "Acalolepta Species", "Indian tv serial sasirekha", "wheelchair woman and accident when young", "Person behind wildlife protection act"," Canada weightlifter", "extraction of marine reserve", "under 20 championship in ireland", "painter famous for landscapes"]
isRelevant = {"ministry of zambia":["Yes", "No", "No", "No", "No", "No", "No", "No", "No", "No"],
                ...
                "Indian tv serial sasirekha":["No","Yes","No", "No", "No", "No", "No", "No", "No","No"],
                "wheelchair woman and accident when young":["No","Yes","No", "No", "No", "No", "No", "No", "No","No"],
                "Person behind wildlife protection act":["Yes", "No", "No", "No", "No", "No", "No", "No", "No", "No"],
                " Canada weightlifter":["Yes", "Yes", "No", "No", "No", "No", "No", "No", "No", "No"],
                "extraction of marine reserve":["Yes","Yes","Yes","Yes","Yes","Yes", "No", "No", "No", "No"],
                "under 20 championship in ireland":["No", "No", "No", "No", "No", "No", "Yes", "No", "No", "No"],
                "painter famous for landscapes":["Yes", "Yes", "No", "No", "No", "No", "No", "No", "No", "No"]}
